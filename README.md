...
cp -r /tmp/agents-scaffold/L3-agents-core/.agents .agents
cp /tmp/agents-scaffold/L3-agents-core/AGENTS.md AGENTS.md
cp /tmp/agents-scaffold/L3-agents-core/CLAUDE.md CLAUDE.md
